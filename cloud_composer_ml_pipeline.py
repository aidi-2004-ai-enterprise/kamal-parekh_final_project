# -*- coding: utf-8 -*-
"""Cloud Composer ML Pipeline

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/186HZ4GTanPMImmwKiqG3aq2SEVIQGRs6
"""
...
with DAG(
    ...
    # --- Bonus Challenge: Email Notification ---
    # To enable email notification, you need to configure SMTP settings in your
    # Cloud Composer environment. Refer to Airflow documentation for details:
    # https://airflow.apache.org/docs/apache-airflow/stable/howto/operator/email.html
    #
    # Uncomment the following task and ensure SMTP is configured correctly.
    # email_notification = EmailOperator(
    #     task_id="send_email_notification",
    #     to=EMAIL_RECIPIENT,
    #     subject="Cloud Composer ML Pipeline Completed!",
    #     html_content="""
    #         <h3>ML Pipeline Execution Complete!</h3>
    #         <p>The ML model training pipeline for London Bicycles data has successfully finished.</p>
    #         <p>Summary of model performance: {{ ti.xcom_pull(key='model_metrics_summary', task_ids='train_model_and_persist') }}</p>
    #         <p>Please check your GCS bucket for the saved model and evaluation metrics.</p>
    #     """,
    # )

    # --- Task Dependencies ---
    # Define the order of execution for the tasks.
    # data_task >> training_task >> notification_task
    # If using email, uncomment the email_notification and adjust the dependency:
    # extract_data_to_bq >> train_model_and_persist >> [log_completion, email_notification]
    extract_data_to_bq >> train_model_and_persist >> log_completion